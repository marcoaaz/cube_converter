...
"QFrame[objectName=\"frame_4\"]{background-color: rgb(210,220,240);}\n"
"QFrame[objectName=\"frame_5\"]{background-color: rgb(210,220,240);}\n"
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 285, 189))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "VSI file"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Select image"))
        self.pushButton_2.setText(_translate("MainWindow", "Browse"))
        self.label_4.setText(_translate("MainWindow", "Tile exports to montage (single pyramids)"))
        ...
        self.checkBox_12.setText(_translate("MainWindow", "Ray tracing in Transmitted light"))
        self.label_3.setText(_translate("MainWindow", "Multi-angle polarisation inputs"))
        ...
        self.label_15.setText(_translate("MainWindow", "Ray tracing intensity calculations"))
        ...
        self.label_17.setText(_translate("MainWindow", "cores"))
        ...
        self.lineEdit_2.setPlaceholderText(_translate("MainWindow", "Add file name"))
...
"  The graphical user interfaces (1) and (2) are an update to the software: https://github.com/marcoaaz/Acevedo-Kamber.\n"
" GUI (1) process proprietary format polarised optical microscopy scans and (2) multi-modal images into open-source pyramidal OME-TIFF format (XYCZT order) that can be opened in OMERO web-server. The black arrow symbolises the requirement for image registration with Imagej/QuPath-Warpy.\n"
" The inputs follow the acquisition sequences defined in ASW software at QUT by Acevedo and Kamber (2023). In (1), to decide the pyramid level required, check the file sizes in \'processed_*/pyramid_sizes.csv\' and benchmark your personal computer performance. GUI (1) and (2) outputs can be opened in QuPath software and fed back to Evident VS200 software suite."))
        ...
        self.label_16.setText(_translate("MainWindow", "Citation when using QUT VS200 slide scanner or this package:\n"
