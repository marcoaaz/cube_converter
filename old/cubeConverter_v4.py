...
# Form implementation generated from reading ui file 'cubeConverter_v4.ui'
#
...
"")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 217, 273))
        ...
        self.gridLayout_11.addWidget(self.checkBox_3, 5, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 197, 67))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 197, 189))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 215, 95))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 215, 95))
...
"(provides flexibility)"))
        self.groupBox.setTitle(_translate("MainWindow", "Multi-angle polarisation"))
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Ray tracing statistics"))
        ...
        self.label_12.setText(_translate("MainWindow", "% percentile (on std and index)"))
        ...
        self.title.setText(_translate("MainWindow", "<html><head/><body><p><br/>The software Step (1) processes polarised optical microscopy scans and Step (2) stacks multi-modal images as pyramidal OME-TIFF format that can be opened in OMERO web-server. Step (1) pyramid level is specified in \'../*_pyramid_sizes.csv\' containing the pixel calibration. All inputs (in proprietary format) and outputs (in open-source) can be opened in QuPath software and Evident VS200 software suite. Step (2) pre-requisite is doing image alignment (or registration) in ImageJ-Fiji BigWarp plugin or QuPath Warpy extension that supports OME-TIFF. </p><p>Step (1) inputs need to follow the acquisition sequences of QUT VS200 petrographic slide scanner by Acevedo and Kamber (2023). The current source code repository (https://github.com/marcoaaz/cube_converter) updates the original scripts (https://github.com/marcoaaz/Acevedo-Kamber) as a pyvips (https://github.com/libvips/pyvips) implementation. </p></body></html>"))
        self.label_14.setText(_translate("MainWindow", "Image converter v1.0 (beta), Date: 10-Dec-25"))
        self.label_19.setText(_translate("MainWindow", "Email feedback to Marco A.: maaz.geologia@gmail.com"))
        self.label_16.setText(_translate("MainWindow", "Citations:\n"
" https://doi.org/10.3390/min13020156 \n"
" https://doi.org/10.1111/jmi.13284"))
