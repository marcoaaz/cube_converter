...
for file_input in path_list:  
    ...
    <OME Creator="OME Bio-Formats 7.0.1" 
        UUID="urn:uuid:b11ead14-703a-4817-a431-c0d32d795225" 
        ...
        <Image ID="Image:0">
            ...
            <Pixels BigEndian="true"
                    ...
                    <TiffData IFD="0" FirstC="0" FirstZ="0" FirstT="0" PlaneCount="1">
                        <UUID FileName="RL.ome.tif">urn:uuid:b11ead14-703a-4817-a431-c0d32d795225</UUID>
                    </TiffData>                    
            </Pixels>            
        </Image>        
    </OME>""")
