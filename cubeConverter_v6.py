...
# Form implementation generated from reading ui file 'cubeConverter_v6.ui'
#
...
"")
        ...
        self.pushButton_6.setIconSize(QtCore.QSize(16, 36))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 238, 162))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 238, 89))
        ...
        self.gridLayout_13.addWidget(self.checkBox_12, 0, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 229, 141))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 246, 95))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 246, 95))
        ...
        self.label_13.setMaximumSize(QtCore.QSize(250, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_3.setPlaceholderText(_translate("MainWindow", "Optional folder path (a different drive allowed)"))
        self.pushButton_6.setText(_translate("MainWindow", "Browse Folder"))
        self.label_15.setText(_translate("MainWindow", "Input optical scans (VSI format)"))
...
"(unpolarised)"))
        self.groupBox.setTitle(_translate("MainWindow", "Calculated montage outputs"))
        ...
        self.label_11.setText(_translate("MainWindow", "Contrast"))
        self.label_12.setText(_translate("MainWindow", "%ile stretching"))
        ...
        self.label_10.setText(_translate("MainWindow", "Output files"))
        self.lineEdit_2.setPlaceholderText(_translate("MainWindow", "File/Folder basename"))
        self.pushButton_5.setText(_translate("MainWindow", "Browse Folder"))
        self.label_7.setText(_translate("MainWindow", "Input images (same WxH, 1 or 3 channels)"))
        ...
        self.label_13.setText(_translate("MainWindow", "µm/px (scale bar)"))
        self.pushButton_8.setText(_translate("MainWindow", "Run"))
        self.label_14.setText(_translate("MainWindow", "Cube Converter v1.2 (update: 15-Apr-26)"))
        self.label_19.setText(_translate("MainWindow", "User feedback to: maaz.geologia@gmail.com"))
        self.label_16.setText(_translate("MainWindow", "<html><head/><body><p>Citations: Ray tracing ( https://doi.org/10.3390/min13020156 ) and POAM ( https://doi.org/10.1111/jmi.13284 )</p></body></html>"))
        self.title.setWhatsThis(_translate("MainWindow", "<html><head/><body><p align=\"justify\"><br/></p></body></html>"))
        self.title.setText(_translate("MainWindow", "<html><head/><body><p>Step (1) uses VS200 polarised optical microscopy scans (.vsi) following Acevedo and Kamber (2023) data acquisition protocol. Step (1) focuses on ray tracing and Step (2) on stacking multi-modal images as pyramidal OME-TIFF for navigation in QuPath, OMERO server, and Evident VS200 software suite. Read Step (1) pyramid level pixel calibration in \'../*_pyramid_sizes.csv\'. Contrast stretching includes min/max index, standard deviation, modulation, and grain boundary images. Step (2) pre-requisite are carefully aligned images of the same size (use: Chemistry Simplifier, ImageJ BigWarp; QuPath Warpy). </p></body></html>"))
